...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['IsInstalled', 'switch_languages', 'ip_block'])->group(function () {
        ...
        Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
            ...
            Route::middleware(['is_admin'])->group(function () {
                ...
                Route::resource('about-khalilak', 'AboutMissionController');
                ...
                Route::get('all/volunteer/request', 'InstructorRequestController@volunteerIndex')->name('volunteer.pending');
                Route::get('all/volunteer', 'InstructorRequestController@allvolunteer')->name('all.volunteer');
                Route::get('all/jobs/request', 'FindJobController@pending')->name('jobs.pending');
                Route::resource('requestjob', 'FindJobController');
            ...
            Route::prefix('alluser')->group(function () {
                ...
                Route::get('/pending', 'AlluserController@pendingUser')->name('pendingUser.index');
            ...
            Route::prefix('allvolunteer')->group(function () {

                Route::get('/', 'AllVolunteerController@viewAllUser')->name('allvolunteer.index');
                Route::get('/alladdvolunteer', 'AllVolunteerController@create')->name('allvolunteer.add');
                Route::post('/allinsertvolunteer', 'AllVolunteerController@store')->name('allvolunteer.store');
                Route::get('edit/{id}', 'AllVolunteerController@edit')->name('allvolunteer.edit');
                Route::put('/edit/{id}', 'AllVolunteerController@update')->name('allvolunteer.update');
                Route::delete('delete/{id}', 'AllVolunteerController@destroy')->name('allvolunteer.delete');
            });
            ...
            Route::post('delete-users', 'OrderController@deleteAllCourseUsers')->name('order.deleteAllCourseUsers');
        ...
        Route::middleware(['admin_instructor', 'IsInstalled', 'auth'])->group(function () {
            ...
            Route::resource('level', 'ChapterLevelController');
            ...
            Route::post("level/dropdown", "CourseclassController@upload_info");
            ...
            Route::resource('placement-test-report', 'placementTestReportController');
            ...
            Route::get('show/placementTestReport/{id}', 'QuizTopicController@placementTestShowReport')->name('show.placementTestReport');
            Route::get('placement-test', 'QuizTopicController@placementTestIndex')->name('index.placementTest');
            ...
            Route::get('levels/status', 'ChapterLevelController@status')->name('levels.status');
            ...
            Route::post('levels/bulk_delete', 'ChapterLevelController@bulk_delete')->name('levels.bulk_delete');
            ...
            Route::post('questionnaire/bulk_delete', 'QuestionnaireController@bulk_delete')->name('questionnaire.bulk_delete');
            ...
            Route::post('findJobrequestDeleteAll', 'BulkdeleteController@findJobrequestdeleteAll')->name('findJobrequest.bulk.delete');
            ...
            Route::get('/e-library-class/{id}', 'CourseclassController@elibraryClass')->name('elibrary.class');
            Route::get('/e-library-class/edit/{id}', 'CourseclassController@elibraryEdit')->name('elibrary.class.edit');
            ...
            Route::get('/e-library', 'CoursechapterController@elibraryindex')->name('elibrary.index');
            Route::post('/e-library/store', 'CoursechapterController@elibrarystore')->name('elibrary.store');
            Route::get('/e-library/edit/{id}', 'CoursechapterController@elibraryedit')->name('elibrary.edit');
            Route::post('/e-library/update/{id}', 'CoursechapterController@elibraryupdate')->name('elibrary.update');
    ...
    Route::middleware(['is_verified', '2fa', 'maintanance_mode', 'switch_languages'])->group(function () {
        ...
        if (env('DEFAULT_THEME') == 'classic') {
            ...
            Route::get('joinUs', 'AllVolunteerController@volunteerRequest')->name('allvolunteer.volunteerRequest');
            Route::post('insertvolunteer', 'AllVolunteerController@volunteerRequestStore')->name('allvolunteer.volunteerRequestStore');
