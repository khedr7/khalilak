...
Route::middleware(['ip_block'])->group(function () {
	...
	Route::post('fblogin', 'Api\Auth\LoginController@fblogin'); //no
	Route::post('googlelogin', 'Api\Auth\LoginController@googlelogin'); //no

	Route::get('social/login/{provider}', 'Api\Auth\LoginController@redirectToblizzard_sociallogin'); //no

	Route::post('social/login/{provider}/callback', 'Api\Auth\LoginController@blizzard_sociallogin'); //no

	Route::post('register', 'Api\Auth\RegisterController@register');
	Route::post('joinUs/register', 'Api\Auth\RegisterController@joinUsVolunteer');
	...
	Route::get('home', 'Api\MainController@home'); //no?
	...
	Route::get('discount/course', 'Api\MainController@discountcourses'); //no

	Route::get('bundle/courses', 'Api\MainController@bundle'); //no
	...
	Route::get('payment/apikeys', 'Api\PaymentController@apikeys'); //no
	...
	Route::get('career', 'Api\MainController@career'); //no
	Route::get('zoom', 'Api\MainController@zoom'); //no
	Route::get('bigblue', 'Api\MainController@bigblue'); //no
	...
	Route::group(['middleware' => ['auth:api']], function () {
		...
		Route::post('join-us', 'Api\Auth\RegisterController@userToVolunteer');


		Route::post('logout', 'Api\Auth\LoginController@logoutApi');

		//my level courses
		Route::get('course/my-level', 'Api\MainController@mylvlcourse');

		//questionnaire
		Route::post('questionnaire', 'Api\MainController@questionnaire');
		...
		//e-library
		Route::get('e-library', 'Api\MainController@allElibrary');
		Route::get('e-library/levels', 'Api\MainController@elibraryLevels');
		Route::get('e-library/classes', 'Api\MainController@elibraryClasses');
		Route::get('e-library/classes/featured', 'Api\MainController@featuredElibraryClasses');
		...
		Route::post('apply/coupon', 'Api\CouponController@applycoupon'); //no
		Route::post('remove/coupon', 'Api\CouponController@remove'); //no

		Route::post('assignment/submit', 'Api\MainController@assignment');

		Route::post('appointment/request', 'Api\MainController@appointment'); //no

		Route::post('question/submit', 'Api\MainController@question');

		Route::post('answer/submit', 'Api\MainController@answer'); //no

		Route::post('appointment/delete/{id}', 'Api\MainController@appointmentdelete'); //no
		...
		Route::get('quiz', 'Api\MainController@getQuiz');

		//Placement Test
		Route::post('placement-test/submit', 'Api\MainController@submitPlacementTest');
		Route::get('placement-test/report', 'Api\MainController@placementTestReport');
		Route::get('placement-test', 'Api\MainController@getPlacementTest');

		Route::get('user/bankdetails', 'Api\OtherApiController@userbankdetail'); //no
		Route::post('add/bankdetails', 'Api\OtherApiController@addbankdetail'); //no 
		Route::post('update/bankdetails/{id}', 'Api\OtherApiController@updatebankdetail'); //no

		/*Wallet API */
		Route::get('wallet/walletdetails', 'Api\OtherApiController@getWallet'); //no
		Route::get('wallet/wallettransactions', 'Api\OtherApiController@getWalletTransactions'); //no
		...
		Route::get('questions', 'Api\InstructorApiController@getAllquestions'); //question and answers
		...
		Route::get('quiz/reports/{id}', 'Api\MainController@p');

		Route::post('find-job', 'Api\MainController@findJob');

		//La3younk
		Route::get('la3younk', 'Api\MainController@la3younk');
		Route::post('la3younk/change-online', 'Api\MainController@changeOnlineLa3younk');
	});
	...
	//course language API
	Route::get('courselanguage', 'Api\InstructorApiController@getAlllanguage'); //no
	Route::get('courselanguage/{id}', 'Api\InstructorApiController@getlanguage'); //no
	Route::post('courselanguage', 'Api\InstructorApiController@createlanguage'); //no
	Route::post('courselanguage/{id}', 'Api\InstructorApiController@updatelanguage'); //no
	Route::delete('courselanguage/{id}', 'Api\InstructorApiController@deletelanguage'); //no

	//categories API
	Route::get('category/subcategory', 'Api\InstructorApiController@subcategoryByCategory');
	...
	Route::post('category', 'Api\InstructorApiController@createcategory'); //no
	Route::post('category/{id}', 'Api\InstructorApiController@updatecategory'); //no
	Route::delete('category/{id}', 'Api\InstructorApiController@deletecategory'); //no

	//subcategories API
	Route::get('subcategory/childcategory', 'Api\InstructorApiController@childcategoryBuSubcategory');
	...
	Route::post('subcategory', 'Api\InstructorApiController@createsubcategory'); //no
	Route::post('subcategory/{id}', 'Api\InstructorApiController@updatesubcategory'); //no
	Route::delete('subcategory/{id}', 'Api\InstructorApiController@deletesubcategory'); //no
	...
	Route::post('childcategory', 'Api\InstructorApiController@createchildcategory'); //no
	Route::post('childcategory/{id}', 'Api\InstructorApiController@updatechildcategory'); //no
	Route::delete('childcategory/{id}', 'Api\InstructorApiController@deletechildcategory'); //no


	//Courses API

	Route::post('instructor/course', 'Api\InstructorApiController@createcourse'); //no
	Route::post('instructor/course/{id}', 'Api\InstructorApiController@updatecourse'); //no
	Route::delete('instructor/course/{id}', 'Api\InstructorApiController@deletecourse'); //no


	Route::get('refundpolicy', 'Api\InstructorApiController@getAllrefundpolicy'); //no


	//Refund orders API

	Route::get('refundorder/{id}', 'Api\InstructorApiController@getrefund'); //no
	Route::post('refundorder/{id}', 'Api\InstructorApiController@updaterefund'); //no
	Route::delete('refundorder/{id}', 'Api\InstructorApiController@deleterefund'); //no
	...
	//categories API
	Route::get('whatlearn', 'Api\InstructorApiController@getAllwhatlearn'); //no
	Route::get('whatlearn/{id}', 'Api\InstructorApiController@getwhatlearn'); //no
	Route::post('whatlearn', 'Api\InstructorApiController@createwhatlearn'); //no
	Route::post('whatlearn/{id}', 'Api\InstructorApiController@updatewhatlearn'); //no
	Route::delete('whatlearn/{id}', 'Api\InstructorApiController@deletewhatlearn'); //no
	...
	Route::get('childcategory-page/{id}', 'Api\MainController@childcategoryPage');
	...
	Route::get('videosetting', 'Api\MainController@videosetting'); //no
