...
class PaymentController extends Controller
{
    ...
    public function enroll(Request $request)
    {
        ...
        $auth = Auth::user();
        $user_level = PlacementTestReport::where('user_id', $auth->id)->first();
        ...
        if ($course) {
            ...
            return response()->json(array('message' => 'User has successfully send Enroll request', 'status' => 'success'), 200);
        } else {
            return response()->json(array('message' => 'This course is not in your level', 'status' => 'error'), 400);
        }
    }
