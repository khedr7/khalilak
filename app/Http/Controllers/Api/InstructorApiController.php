...
class InstructorApiController extends Controller
{
    ...
    public function getAllsubcategory(Request $request) {
        ...
        return response()->json(array('subcategory'=>$result), 200); 
    }
    ...
    public function childcategoryBuSubcategory(Request $request) {
        ...
        $categories = ChildCategory::where('subcategory_id',$request->subcategory_id)->get();
    ...
    public function getAllquestions(Request $request) {
        ...
        $question = Question::where('course_id', $request->course_id)->get();
        ...
        foreach ($question as $data) {
            ...
            $result[] = array(
                ...
                'user_id' => $data->id,
                'english user name' => optional($data->user)['fname'] ,
                'arabic user name' => optional($data->user)['lname'] ,
