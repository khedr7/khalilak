...
class CoursechapterController extends Controller
{
    ...
    {
        $coursechapter = CourseChapter::all()->where('course_id', "!=", null);
    ...
    {
        $coursechapter = CourseChapter::all()->where('course_id', "=", null);
        return view('admin.elibrary.elibrarychapter.index', compact("coursechapter"));
    }
    ...
    public function elibraryedit($id)
    {
        ...
        return view('admin.elibrary.elibrarychapter.edit', compact("cate"));
    }
