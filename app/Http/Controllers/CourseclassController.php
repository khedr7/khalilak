...
class CourseclassController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $courseclass->level_id =  $request->level;
        ...
        // Notification when course class
        ...
        if ($courseclass->course_id == null) {
            Session::flash('success', trans('flash.UpdatedSuccessfully'));
            return redirect()->route('elibrary.class', $courseclass->coursechapter_id);
        } else {
    ...
    public function elibraryClass($id)
    {
        $e_chapter = CourseChapter::findorfail($id);
        $classes = CourseClass::all()->where('coursechapter_id', '=', $id);
        $coursechapters = CourseChapter::all()->where('course_id', '=', null);
        // $levels = ChapterLevel::all()->where('chapter_id', '=', $id);
        return view('admin.elibrary.elibraryclass.index', compact("e_chapter", "classes", "coursechapters"));
    }
    ...
    public function elibraryEdit($id)
    {
        ...
        $subtitles = Subtitle::where('c_id', $id)->get();
        $cate = CourseClass::find($id);
        $coursechapt = CourseChapter::all()->where('course_id', '=', null);
        $levels = ChapterLevel::all()->where('chapter_id', '=', $id);
        ...
        return view('admin.elibrary.elibraryclass.edit', compact('cate', 'coursechapt', 'subtitles', 'live_date'));
    }
    ...
    public function upload_info(Request $request)
    {
        ...
        $id = $request['catId'];
        $upload = ChapterLevel::where('chapter_id', $id)->pluck('title', 'id')->all();
