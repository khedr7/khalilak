...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::User()->role == "admin") {
            ...
            $userss = User::where('status', '!=', 0)->count();
            $usergraph = array(
                User::whereDate('created_at', '=', Carbon::now()->subdays(1))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(2))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(3))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(4))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(5))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(6))->where('status', '!=', 0)->count(),
                User::whereDate('created_at', '=', Carbon::now()->subdays(7))->where('status', '!=', 0)->count(),
            );
            ...
            $instructor = User::where('role', '=', 'instructor')->where('status', '!=', 0)->count();
            $instructorgraph = array(
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(1))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(2))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(3))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(4))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(5))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(6))->where('status', '!=', 0)->count(),
                User::where('role', '=', 'instructor')->whereDate('created_at', '=', Carbon::now()->subdays(7))->where('status', '!=', 0)->count(),
            );
            $topuser = User::where('role', '=', 'user')->where('status', '!=', 0)->orderBy('id', 'DESC')->take(5)->get();
            $topinstructor = User::where('role', '=', 'instructor')->where('status', '!=', 0)->orderBy('id', 'DESC')->take(5)->get();
            $topcourses = Course::orderBy('id', 'DESC')->take(5)->get();
            $toporder = Order::orderBy('id', 'DESC')->take(5)->get();
            $admin = User::where('role', '=', 'admin')->count();
            $admins = User::where('role', '=', 'admin')->count();
            $instructors = User::where('role', '=', 'instructor')->count();
            $users = User::where('role', '=', 'user')->where('status', '!=', 0)->count();
