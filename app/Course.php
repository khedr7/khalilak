...
class Course extends Model
{
    ...
    protected $fillable = [
        ...
        'short_detail', 'detail',  'price', 'discount_price', 'day', 'video', 'video_url',
        'featured', 'requirement', 'url', 'slug', 'status', 'preview_image', 'type',
        'preview_type', 'duration', 'duration_type', 'instructor_revenue', 'involvement_request',
        'refund_policy_id', 'assignment_enable', 'appointment_enable', 'certificate_enable',
