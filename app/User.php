...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'fname', 'email', 'user_name', 'password', 'lname', 'dob', 'doa', 'mobile', 'address', 'city_id',
        'state_id', 'country_id', 'gender', 'pin_code', 'status', 'verified', 'role', 'married_status',
        'user_img', 'detail', 'braintree_id', 'fb_url', 'twitter_url', 'youtube_url', 'linkedin_url',
        'email_verified_at', 'code', 'google_id', 'facebook_id', 'amazon_id', 'gitlab_id', 'linkedin_id',
        ...
        'blind', 'latest_obtained_degree', 'degree_completed', 'study', 'profession',
        'association', 'english_level', 'comment', 'disabled', 'Reason_for_joining', 'type', 'file',
        'interview_date', 'accepted', 'online'
    ];
    ...
    {
        return $this->belongsToMany(QuizTopic::class, 'user_quiz', 'user_id', 'quiz_topic_id');
    }

    // one to many
    public function findJobs()
    {
        return $this->hasMany(FindJob::class);
    }
