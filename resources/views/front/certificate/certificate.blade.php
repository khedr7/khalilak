        ...
        <div class="row">
            <div class="col-lg-9 col-md-8">
                ...
                <div class="cirtificate-border-one text-center">
                    {{-- <img src="/images/certificate/template.jpg" alt="Snow" style="width:100%;"> --}}
                    <div class="cirtificate-border-two">
                       ...
                       <span class="cirtificate-instructor">{{ ($course->user['fname']) }}</span>
                       <br>
                       <span class="cirtificate-one">{{ ($course->user['fname']) }} , {{ __('Instructor') }}</span>
                       <br>
                       <span>&</span>
