            ...
            @if ($topic->timer != null)
                <div class="text-center">
                    ...
                    <body onload="countdown();">
                        <div
                            style="border: none; font-size: 16px; font-weight: bold; color: black; background: transparent;">
                            {{ __('Quiz Timer') }}
                            <input id="minutes" type="text"
                                style="width: 20px; border: none; font-size: 16px;  font-weight: bold; color: black; background: transparent;">
                            <font size="5"> : </font>

                            <input id="seconds" type="text"
                                style="width: 100px; border: none; font-size: 16px;  font-weight: bold; color: black; background: transparent;">
                        ...
                        <div id="question_block" class="question-block">
                            <div class="question" id="question-div">
                                ...
                                <form action="{{ route('start.quiz.store', $topic->id) }}" method="POST" id="question-form">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="jumbotron" id="quiz1">
                                                    <h4 style="color:black;">
                                                        Q{{ $count }}.&emsp;{{ $que[0]['question'] }}</h4>
                                                    ...
                                                    <input type="hidden" id="canswer[{{ $count }}]"
                                                        ...
                                                        value="{{ $que[0]['answer'] }}">
                                                    <label class="radio">
                                                        <input type="radio" class="q_answer" required
                                                            name="answer[{{ $count }}]"
                                                            value="A">{{ $que[0]['a'] }}
                                                    </label>
                                                    <label class="radio">
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        ...
                                                        @if (isset($que[0]['question_video_link']))
                                                            <div class="tab-pane fade show active" id="home"
                                                                ...
                                                                <div
                                                                    style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 95.25%;">
                                                                    <iframe
                                                                        src="{{ $que[0]['question_video_link'] . '?modestbranding=1' }}"
                                                        ...
                                                        @if (isset($que[0]['question_img']))
                                                            <div class="tab-pane fade show" id="profile"
                                                                ...
                                                                <img src="{{ asset('images/quiz/' . $que[0]['question_img']) }}"
                                                                    class=" img-fluid" alt="">
                                                            </div>
                                                        @endif
                                                    </div>
                                    ...
                                    @foreach ($que as $key => $equestion)
                                        @if ($key > 0)
                                            <div style="display: none;" id="more_quiz{{ $key }}">
                                                <div>
                                                    <span
                                                        id="quizNumber">{{ $count }}</span><span>/{{ $que_count }}</span>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                            ...
                                                            <div class="tab-content" id="myTabContent">
                                                                @if (isset($equestion['question_video_link']))
                                                                    <div class="tab-pane fade show active" id="home"
                                                                        ...
                                                                        <div
                                                                            style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 95.25%;">
                                                                            <iframe
                                                                                src="{{ $equestion['question_video_link'] . '?modestbranding=1' }}"
                                                                                style="border: 0; top: 0; left: 0; width: 100%; height: 100%; position: absolute;"
                                                                                allowfullscreen scrolling="no"
                                                                                allow="encrypted-media">
                                                                ...
                                                                @if (isset($equestion['question_img']))
                                                                    <div class="tab-pane fade" id="profile"
                                                                        role="tabpanel" aria-labelledby="profile-tab">
                                                                        <img src="{{ asset('images/quiz/' . $equestion['question_img']) }}"
                                                                            class=" img-fluid" alt="">
                                                                    </div>
                                                                @endif
                                    ...
                                    <button style="display: none;" id="prev"
                                        title="{{ __('Click to see previous question') }}" class="btn btn-md btn-primary"
                                        value="1">
                                        << {{ __('Prev') }}</button>
                                            @if ($que_count > 1)
                                                <button title="{{ __('Click to see next question') }}" id="next"
                                                    class="pull-right btn btn-md btn-primary"
                                                    value="0">{{ __('Next') }} >></button>
                                            @else
                                                <button title="Finish the quiz" type="submit"
                                                    class="btn btn-md btn-primary">{{ __('Finish') }}</button>
                                            @endif
                    ...
                    if (mins < 0) {
                        ...
                        if (count == 0) {
                            ...
                            window.location.href =
                                '{{ route('course.content', ['id' => $topic->courses->id, 'slug' => $topic->courses->slug]) }}';
                            // return false;
                        }
