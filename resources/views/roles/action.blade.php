<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
        ...
        @if (!in_array($id, ['1', '2', '3']))
            <a class="dropdown-item" href="{{ route('roles.edit', $id) }}"><i
        ...
        @if (!in_array($id, ['1', '2', '3']))
            <a class="dropdown-item"
                @if (env('DEMO_LOCK') == 0) data-toggle="modal" data-target="#delete{{ $id }}" @else
      disabled="disabled" title="This operation is disabled in Demo !" @endif><i
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p>{{ __('Do you really want to delete this role') }} <b>{{ $name }}</b> ? <b>
                        {{ __('By Clicking YES IF any user attach to this role will be unroled !</b> This process cannot be undone') }}.
                </p>
            </div>
