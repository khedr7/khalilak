        ...
        <div class="contentbar">
            ...
            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-7">
                                            ...
                                            @endphp</h4>
                                            <p class="font-14 mb-0">Courses</p>
                                        </div>
                                        <div class="col-5 text-right">
                                            <a href="{{ url('course') }}">
                                                <div><i class="text-success feather icon-book-open"
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            ...
                                            <p class="font-14 mb-0">User Enrolled</p>
                                        </div>
                                        <div class="col-5 text-right">
                                            <a href="{{ url('userenroll') }}">
                                                <div><i class="text-warning feather icon-users" style="font-size:45px;"></i>
                                                </div>
                                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            ...
                                            @endphp</h4>
                                            <p class="font-14 mb-0">Total Question</p>
                                        </div>
                                        <div class="col-5 text-right">
                                            <a href="{{ url('instructorquestion') }}">
                                                <div><i class="text-info feather icon-file-plus"
                                                        style="font-size:45px;"></i></div>
                                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            ...
                                            @endphp</h4>
                                            <p class="font-14 mb-0">Total Answer</p>
                                        </div>
                                        <div class="col-5 text-right">
                                            <a href="{{ url('instructoranswer') }}">
                                                <div><i class=" text-secondary feather icon-x-square"
                                                        style="font-size:45px;"></i></div>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            <h4>@php
                                                $answer = App\Course::where('user_id', Auth::User()->id)
                                                    ->where('status', '1')
                                                    ->where('featured', '1')
                                                    ->get();
                                                if (count($answer) > 0) {
                                            ...
                                            @endphp</h4>
                                            <p class="font-14 mb-0">Featured Courses</p>
                                        </div>
                                        <div class="col-5 text-right">
                                            <a href="{{ url('featurecourse') }}">
                                                <div><i class=" text-danger feather icon-user-plus"
                                                        style="font-size:45px;"></i></div>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            <h4> @php
                                                $answer = App\Blog::where('user_id', Auth::User()->id)
                                                    ->where('status', '1')
                                                    ->get();
                                                if (count($answer) > 0) {
                                                    echo count($answer);
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-7">
                                                ...
                                                @endphp</h4>
                                                <p class="font-14 mb-0">Zoom Meeting</p>
                                            </div>
                                            <div class="col-5 text-right">
                                                <a href="{{ route('zoom.index') }}">
                                                    <div><i class="text-info feather icon-video"
                                                            style="font-size:45px;"></i></div>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-7">
                                                <h4> @php
                                                    $answer = App\BBL::where('instructor_id', Auth::User()->id)
                                                        ->where('is_ended', '0')
                                                        ->get();
                                                    if (count($answer) > 0) {
                                                        echo count($answer);
                                                ...
                                                @endphp</h4>
                                                <p class="font-14 mb-0">Big Blue Meeting</p>
                                            </div>
                                            <div class="col-5 text-right">
                ...
                <div class="col-lg-12">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="card-title">Total Enrollment in {{ (new DateTime)->format("Y") }}</h5>
                        </div>
                        <div class="card-body">
                ...
                {{-- <div class="col-md-12">
                    <div class="card m-b-30 ">
                        <div class="card-header">
                            <h5 class="card-title">Monthly Instructor Payout</h5>
                        </div>
                        <div class="card-body">
