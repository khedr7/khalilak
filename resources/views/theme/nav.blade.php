                        ...
                        <ul>
                            @if (Auth::User()->role == 'admin')
                                <a target="_blank" href="{{ url('/admins') }}">
                                    <li><i data-feather="pie-chart"></i>{{ __('frontstaticword.AdminDashboard') }}</li>
                                </a>
                            @endif
                            ...
                            <a href="{{ route('purchase.show') }}">
                                <li><i data-feather="shopping-cart"></i>{{ __('frontstaticword.PurchaseHistory') }}</li>
                            </a>
                            ...
                            @if (env('ENABLE_INSTRUCTOR_SUBS_SYSTEM') == 1)
                                @if (Auth::User()->role == 'instructor')
                                    <a href="{{ route('plan.page') }}">
                                        <li><i data-feather="tag"></i>{{ __('frontstaticword.InstructorPlan') }}</li>
                                    </a>
                                @endif
                            @endif
                            ...
                            @if (Auth::User()->role == 'user' || Auth::User()->role == 'instructor')
                                @if ($gsetting->device_control == 1)
                                    <a href="{{ route('active.courses') }}" title="Watchlist">
                                        <li><i data-feather="framer"></i>{{ __('frontstaticword.Watchlist') }}</li>
                                    </a>
                                @endif
                            @endif
                            ...
                            @if (Schema::hasTable('affiliate') && Schema::hasTable('wallet_settings'))
                                ...
                                @if (isset($wallet_settings) && $wallet_settings->status == 1)
                                    <a href="{{ url('/wallet') }}">
                                        <li><i class="icon-wallet icons"></i>{{ __('frontstaticword.MyWallet') }}</li>
                                    </a>
                                @endif
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4 col-sm-12">
                        <div class="logo">
                            ...
                            @if ($gsetting->logo_type == 'L')
                                <a href="{{ url('/') }}"><img
                                        src="{{ asset('images/logo/' . $gsetting->logo) }}" class="img-fluid"
                                        alt="logo"></a>
                            @else()
                                <a href="{{ url('/') }}"><b>
                                        <div class="logotext">{{ $gsetting->project_title }}</div>
                            ...
                            <div id="cssmenu">
                                <ul>
                                    <li><a href="#" title="Categories"><i
                                                data-feather="grid"></i>{{ __('frontstaticword.Categories') }}</a>
                ...
                @guest
                    <div class="row">
                        ...
                        {{-- <div class="col-lg-7">
                            <div class="Login-btn">
                                <a href="" data-toggle="modal" data-target="#myModalinstructor"
                                    class="btn btn-primary" title="Become an Volunteer">Become a Volunteer</a>
                                <a href="{{ route('allvolunteer.volunteerRequest') }}" class="btn btn-primary"
                                    title="joinUs">{{ __('frontstaticword.BecomeaVolunteer') }}</a>
                            </div>
                        </div> --}}
                        <div class="col-lg-3">
                            <div class="Login-btn">
                                    ...
                                    <ul id="nav">
                                        <li id="notification_li">
                                            ...
                                            <div id="notificationContainer">
                                                <div id="notificationTitle">{{ __('frontstaticword.Notifications') }}
                                                </div>
                                                <div id="notificationsBody" class="notifications">
                                                    <ul>
                                                        @foreach (Auth()->user()->unreadNotifications->where('type', 'App\Notifications\UserEnroll') as $notification)
