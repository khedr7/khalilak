            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('topdiscounted/view') }}" class="btn btn-secondary" title="View More">View
                            More
                        </a>
                    </div>
                </div>
...
<!-- Student start -->
@if (Auth::check())
    @if ($hsetting->recentcourse_enable == 1 &&
    ...
    <section id="student" class="student-main-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="view-button txt-rgt">
                        <a href="{{ url('featuredcourse/view') }}" class="btn btn-secondary" title="View More">View
                            More
                        </a>
                    </div>
                </div>
...
@if (!$bestselling->isEmpty() && $hsetting->bestselling_enable && isset($bestselling) && count($bestselling) > 0)
    <section id="student" class="student-main-block">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="student-heading">{{ __('Best Enroll Courses') }}</h4>
                </div>
                <div class="col-lg-6">
                    <div class="view-button txt-rgt">
                        ...
                        <div class="col-lg-4 col-sm-5">
                            <div class="recommendations-block">
                                ...
                                <div class="recommendation-btn">
                                    <a href="{{ route('allvolunteer.volunteerRequest') }}" {{-- data-toggle="modal" data-target="#myModalinstructor" --}}
                                        class="btn btn-primary" title="Become an Instructor">Become a
                                        Volunteer</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <a
                                        ...
                                        <div class="image-overlay">
                                            <span><i class="fa {{ $t['icon'] }}"></i>{{ $t['title'] }}
                                                <div class="categories-img-count">{{ $t->courses->count() }}
                                                    {{ __('Courses') }}</div>
                                            </span>
                                        </div>
                                        @if ($t['cat_image'] == !null)
