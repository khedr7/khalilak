            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    <button type="button" class="float-right btn btn-primary-rgba mr-2" data-toggle="modal" data-target="#create">
                        <i class="feather icon-plus mr-2"></i>{{ __('Add Level') }}</button>
                    {{-- @endcan --}}
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-box">{{ __('All e-Library list levels') }}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('adminstaticword.e-Library type') }}</th>
                                    ...
                                    @foreach ($levels as $level)
                                        ...
                                        <tr>
                                            <td><input type='checkbox' form='bulk_delete_form'
                                                    ...
                                                    value='{{ $level->id }}' id='checkbox{{ $level->id }}'>
                                                <label for='checkbox{{ $level->id }}' class='material-checkbox'></label>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form id="bulk_delete_form" method="post"
                                                                    action="{{ route('levels.bulk_delete') }}">
                                                                    @csrf
                                                                    @method('POST')
                                                                    <button type="reset"
                                            ...
                                            <td>
                                                @if (isset($level->chapter))
                                                    {{ $level->chapter->chapter_name }}
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="index-image">
                                                    <i class="fa {{ $level->icon }}"></i>
                                                </div>
                                            </td>
                                            <td>{{ $level->slug }}</td>
                                            <td>
                                                <button type="button"
                                                    class="btn btn-rounded {{ ($level->status == '1' ? 'checked' : '') ? 'btn-success-rgba' : 'btn-danger-rgba' }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade bd-example" id="edit{{ $level->id }}"
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="demo-form" method="post"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <label
                                                                                for="exampleInputSlug">{{ __('adminstaticword.Select e-Library type') }}</label>
                                                                            <select name="chapter_id"
                                                                                class="form-control select2">

                                                                                @foreach ($chapters as $chp)
                                                                                    <option value="{{ $chp->id }}"
                                                                                        {{ $level->chapter_id == $chp->id ? 'selected' : '' }}>
                                                                                        {{ $chp->chapter_name }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <label
                                                                                for="exampleInputTit1e">{{ __('adminstaticword.Level') }}:<span
                                                ...
                                                <div class="modal fade bd-example-modal-sm"
                                                    id="delete{{ $level->id }}" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleSmallModalLabel">
                            ...
                            <div class="modal fade bd-example-modal-sm" id="create" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="demo-form2" method="post" action="{{ url('level/') }}"
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <form id="demo-form2" method="post"
                                                            action="{{ url('level/') }}" data-parsley-validate
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <label
                                                                        for="exampleInputTit1e">{{ __('adminstaticword.e-Library type') }}</label>
                                                                    <select name="chapter_id"
                                                                        class="form-control select2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label
                                                                        for="exampleInputTit1e">{{ __('adminstaticword.Level') }}:<sup
                                                                            class="redstar">*</sup></label>
