            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    @can('faq.faq-instructor.create')
                        <a href="{{ url('faqinstructor/create') }}" class="float-right btn btn-primary-rgba mr-2"><i
                                ...
                                <tbody>
                                    @foreach ($faq as $key => $p)
                                        <tr id="tr_{{ $p->id }}">
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input class="faqinstructor" type="checkbox"
                                                        data-id="{{ $p->id }}" name="status"
                                                        {{ $p->status == '1' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                        @can('faq.faq-instructor.edit')
                                                            <a class="dropdown-item"
                                                                href="{{ url('faqinstructor/' . $p->id . '/edit') }}"><i
