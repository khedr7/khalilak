    ...
    @component('components.breadcumb', ['fourthactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ url('faqinstructor') }}" class="btn btn-primary-rgba"><i
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <!-- form start -->
                        <form action="{{ url('faqinstructor/' . $find->id) }}" class="form" method="POST" novalidate
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $find->title }}"
                                                                    autofocus=""
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label
                                                                    ...
                                                                    <span class="text-danger">*</span></label>
                                                                <textarea id="detail" rows="3" name="details" class="@error('details') is-invalid @enderror"
                                                                    placeholder="Please Enter Description" required="">{{ $find->details }}</textarea>
                                                                @error('details')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
