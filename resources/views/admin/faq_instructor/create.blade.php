            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <!-- form start -->
                        <form action="{{ url('faqinstructor/') }}" class="form" method="POST" novalidate
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label
                                                                    ...
                                                                    <span class="text-danger">*</span></label>
                                                                <textarea id="detail" rows="3" name="details" class="@error('description') is-invalid @enderror"
                                                                    placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}" required="">{{ old('description') }}</textarea>
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
