            ...
            <div class="card-header">
                ...
                @can('course-chapter.create')
                    <a data-toggle="modal" data-target="#myModalp" href="#" class="btn btn-primary-rgba"><i
                            class="feather icon-plus mr-2"></i>{{ __('Add Course Content') }}</a>
                @endcan
            </div>
            <div class="card-body">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                @can('course-chapter.edit')
                                                    <a class="dropdown-item"
                                                        href="{{ url('coursechapter/' . $cat->id) }}"><i
                        ...
                        <form id="demo-form2" method="post" action="{{ route('coursechapter.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Your Content Name" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="display: none;" id="dripdate1">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date_specific2" class="form-control"
                                                name="drip_date">
