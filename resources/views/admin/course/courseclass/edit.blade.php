    ...
    @component('components.breadcumb', ['thirdactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ url('course/create/' . $cate->courses->id) }}" class="float-right btn btn-primary-rgba mr-2"><i
            ...
            <div class="col-lg-7">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">{{ __('adminstaticword.Edit') }} {{ __('Course Material') }}</h5>
                    </div>
                            ...
                            <select class="d-none" name="coursechapter" class="form-control select2">
                                ...
                                @foreach ($coursechapters as $cat)
                                    <option {{ $cate->coursechapter_id == $cat->id ? 'selected' : '' }}
                                        value="{{ $cat->id }}">{{ $cat->chapter_name }}</option>
                                @endforeach
                            </select>
