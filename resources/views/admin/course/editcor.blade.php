<script type="text/javascript" src="/Resources/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js">
</script>
<script type="text/javascript"
    src="/Resources/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datepicker.pt-BR.min.js" charset="UTF-8">
</script>
                                ...
                                <select name="institude_id" class="form-control select2">
                                    ...
                                    @foreach ($institute as $inst)
                                        <option value="{{ $inst->id }}"
                                            {{ $inst->id == $cor->institude_id ? 'selected' : '' }}>
                                            {{ $inst->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <input type="number" min="1"  class="form-control" name="day" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Enter') }} day" value="{{ $cor->day }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $cor->end_date }}" type="text" id="end-date"
                                    class="default-date form-control" name="end_date" placeholder="yyyy/mm/dd"
                                    aria-describedby="basic-addon2" />
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2"><i
                                            class="feather icon-calendar"></i></span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-info"> <i
                                            class="text-dark feather icon-help-circle"></i>({{ __('Choose Image for post') }})</small>
                                    <br>
