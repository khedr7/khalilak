    ...
    <div class="contentbar">
                ...
                <form class="navbar-form" role="search">
                    <div class="input-group ">
                        ...
                        @if (app('request')->input('searchTerm') != '')
                            <a role="button" title="Back" href="{{ url('course') }}" name="clear" value="search"
                                id="clear_id" class="btn btn-warning-rgba btn-xs">
                                {{ __('Clear Search') }}
                            </a>
                        @endif
            ...
            <div class="col-md-8 text-right mb-2">
                ...
                @if (Auth::User()->role == 'admin')
                    <button type="button" class="btn btn-danger-rgba mr-2" data-toggle="modal"
                        data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i>
                        ...
                        <div class="select-all-checkbox">
                            ...
                            <div>
                                <input id="checkboxAll" type="checkbox"
                                    class="filled-in width-15 height-15 t-3 position-relative" name="checked[]"
                                    value="all" />
                    ...
                    <div id="infobar-settings-sidebar" class="infobar-settings-sidebar">
                        <div class="infobar-settings-sidebar-head d-flex w-100 justify-content-between">
                            ...
                            <a href="javascript:void(0)" id="infobar-settings-close" class="btn btn-primary close">
                                <img src="admin_assets/assets/images/svg-icon/close.svg"
                          ...
                          <option value="free">{{ __('Free') }}</option>
                            ...
                            <div class="custom-mode-setting">
                                <div class="row align-items-center pb-3">
                                    ...
                                    <div class="col-4 text-right"><input type="checkbox" name="status"
                                            class="custom_toggle" checked /></div>
                                </div>
                            ...
                            <div class="custom-mode-setting">
                                <div class="row align-items-center pb-3">
                                    ...
                                    <div class="col-4 text-right"><input type="checkbox" name="featured"
                                            class="custom_toggle" checked /></div>
                                </div>
                            ...
                            <div class="custom-mode-setting">
                                <div class="row align-items-center pb-3">
                                    ...
                                    <div class="col-4 text-right"><input type="checkbox" name="asc"
                                            class="custom_toggle" checked /></div>
                                </div>
                            ...
                            <div class="custom-mode-setting">
                                <div class="row align-items-center pb-3">
                                    ...
                                    <div class="col-4 text-right"><input type="checkbox" name="desc"
                                            class="custom_toggle" checked /></div>
                                </div>
                                        ...
                                        <div class="col-4 text-right">
                                            <div class="form-group">
                                                <div class="update-password">
                                                    <input type="checkbox" id="myCheck" name="category_id"
                                                        class="custom_toggle" onclick="myFunction()" checked>
                                                </div>
                                            </div>
                                        </div>
        ...
        @forelse($course as $cat)
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card">
                    @if ($cat['preview_image'] !== null &&
                        $cat['preview_image'] !== '' &&
                        @file_get_contents('images/course/' . $cat['preview_image']))
                        <img class="card-img-top" src="{{ url('images/course/' . $cat['preview_image']) }}"
                            alt="User Avatar">
                    ...
                    <div class="card-user-img">
                        ...
                        @else
                            <img @error('photo') is-invalid @enderror
                                ...
                                class="img-fluid w-h-100" data-toggle="modal"
                                data-target="#exampleStandardModal{{ $cat->user->id }}">
                        @endif

                    </div>
                    <div class="card-body">
                        {{-- <div style="list-style-type: none;" class="mt-4"><a href="#"
                                style="color:black">{{ __('Type') }} <span class="button-align">
                                    @if ($cat->type == '1')
                                        paid
                                    @else
                                        Free
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li style="list-style-type: none;" class="mt-3">
                                <a href="#" style="color:black">{{ __('Features') }}<span class="button-align">
                                        <input data-id="{{ $cat->id }}" type="checkbox"
                                            class="custom_toggle status1" name="featured"
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li style="list-style-type: none;" class="mt-3">
                                <a href="#" style="color:black">{{ __('Status') }}
                                    <span class="button-align">
                                        <input data-id="{{ $cat->id }}" type="checkbox"
                                            class="custom_toggle status2" name="status"
                    ...
                    <div class="card-footer">
                        <div class="row mt-3 mb-3">
                            ...
                            <div class="col-2">
                                <a href="{{ route('user.course.show', ['id' => $cat->id, 'slug' => $cat->slug]) }}"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="bulk_delete_form" method="post"
                                                action="{{ route('cource.bulk.delete') }}">
                                                @csrf
                                                @method('POST')
                            ...
                            <div class="modal fade" id="exampleStandardModal{{ $cat->user->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            @isset($cat->user->youtube_url)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="p-1">
                                                                                        <a
                                                                                            href="{{ $cat->user->youtube_url }}">{{ str_limit($cat->user->youtube_url, '30') }}</a>
                                                                                    </td>
                                                                                </tr>
                                                                            @endisset
                                                                            ...
                                                                            @isset($cat->user->fb_url)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="p-1">
                                                                                        <a
                                                                                            href="{{ $cat->user->fb_url }}">{{ str_limit($cat->user->fb_url, '30') }}</a>
                                                                                    </td>
                                                                                </tr>
                                                                            @endisset
                                                                            ...
                                                                            @isset($cat->user->twitter_url)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="p-1">
                                                                                        <a
                                                                                            href="{{ $cat->user->twitter_url }}">{{ str_limit($cat->user->twitter_url, '30') }}</a>
                                                                                    </td>
                                                                                </tr>
                                                                            @endisset
                                                                            ...
                                                                            @isset($cat->user->linkedin_url)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="p-1">
                                                                                        <a
                                                                                            href="{{ $cat->user->linkedin_url }}">{{ str_limit($cat->user->linkedin_url, '30') }}</a>
                                                                                    </td>
                                                                                    </td>
                                                                                </tr>
                                                                            @endisset
