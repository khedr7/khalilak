...
@elseif ($topic->course_id == null)
    @section('title', 'Edit Placement Tset')
@endif
{{-- @section('title', 'Edit Quiztopic') --}}
@section('maincontent')
    @component('components.breadcumb', ['thirdactive' => 'active'])
        ...
        @slot('button')
            ...
            @elseif ($topic->course_id == null)
                <div class="col-md-4 col-lg-4">
                    <a href="{{ route('index.placementTest') }}" class="float-right btn btn-primary-rgba"><i
                            class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>
                </div>
            @endif
        @endslot
                    ...
                    <div class="card-body ml-2">
                        <form id="demo-form2" method="POST" action="{{ route('quiztopic.update', $topic->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Quiz Topic" class="form-control "
                                        name="title" id="exampleInputTitle" value="{{ $topic->title }}">
                                </div>
                            </div>
                            <br>
                            ...
                            @if ($topic->course_id !== null)
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="exampleInputTit1e">{{ __('adminstaticword.PerQuestionMarks') }}:<span
                                                class="redstar">*</span> </label>
                                        <input type="number" placeholder="Enter Per Question Mark" class="form-control "
                                            name="per_q_mark" id="exampleInputTitle" value="{{ $topic->per_q_mark }}">
                                    </div>
                                </div>
                                <br>
                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Quiz Time" class="form-control" name="timer"
                                        id="exampleInputTitle" value="{{ $topic->timer }}">
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" placeholder="Enter Due Days" class="form-control"
                                            name="due_days" id="exampleInputTitle" value="{{ $topic->due_days }}">
                                    </div>
                                </div>
                                <br>
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="switch">
                                        <input class="slider" type="checkbox" name="quiz_again"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="switch">
                                        <input class="slider" type="checkbox" name="type"
