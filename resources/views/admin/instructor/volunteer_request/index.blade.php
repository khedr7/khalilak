...
@section('title', 'Pending Volunteer Request - Admin')
@section('maincontent')


    @component('components.breadcumb', ['thirdactive' => 'active'])
        @slot('heading')
            {{ __('Volunteer Request') }}
        @endslot
        @slot('menu1')
            {{ __('Volunteer') }}
        @endslot
        @slot('menu2')
            {{ __('Pending Volunteer Request') }}
        @endslot
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">{{ __('Pending Volunteer Request') }}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('adminstaticword.VolunteerType') }}</th>
                                            ...
                                            @if ($item->status == '0')
                                                <td>
                                                    @if ($item->user->user_img != null && $item->user->user_img != '')
                                                        <img src="{{ asset('images/instructor/' . $item->user->user_img) }}"
                                                            class="img-circle">
                                                    @else
                                                ...
                                                <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post"
                                                                    action="{{ url('requestinstructor/' . $item->id) }}
