                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            <div class="logobar">
                                <a href="{{ url('/admins') }}" class="logo logo-large">
                            ...
                            @canany(['users.view', 'Alluser.view', 'Allinstructor.view'])
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-users text-secondary"></i>
                                        <span>{{ __('Users') }}<div class="sub-menu truncate">All Users, All Students,
                                                All Instructors, All volunteer</div></span>
                                    ...
                                    <ul class="vertical-submenu">
                                        ...
                                        @endcan
                                        {{-- @can('allvolunteer.view') --}}
                                        <li>
                                            <a class="{{ Nav::isResource('allvolunteer') }}"
                                                href="{{ route('allvolunteer.index') }}">{{ __('All Volunteer') }}</a>
                                        </li>
                                        @can('users.view')
                                        <li>
                                            <a class="{{ Nav::isResource('user') }}"
                                                href="{{ route('pendingUser.index') }}">{{ __('Pending Users') }}</a>
                                        </li>
                                    @endcan
                                        {{-- @endcan --}}
                                        {{-- <li>
                            ...
                            @canany(['instructorrequest.view', 'instructor-pending-request.manage',
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-user text-secondary"></i>
                                        <span>{{ __('adminstaticword.Instructors') }}<div class="sub-menu truncate">All
                                                Instructor, Pending Request</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        @can('instructorrequest.view')
                                            <li class="{{ Nav::isRoute('all.instructor') }}"><a
                                                    ...
                                                    {{ __('adminstaticword.Instructors') }}</a></li>
                                        @endcan
                            ...
                            @canany(['instructorrequest.view', 'instructor-pending-request.manage',
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-user text-secondary"></i>
                                        <span>{{ __('adminstaticword.Volunteers') }}<div class="sub-menu truncate">All
                                                Volunteer, Pending Request</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        @can('instructorrequest.view')
                                            <li class="{{ Nav::isRoute('all.volunteer') }}"><a
                                                    href="{{ route('all.volunteer') }}">{{ __('adminstaticword.All') }}
                                                    {{ __('adminstaticword.volunteer') }}</a></li>
                                        @endcan
                                        @can('instructor-pending-request.manage')
                                            <li class="{{ Nav::isRoute('volunteer.pending') }}"><a
                                                    href="{{ route('volunteer.pending') }}">{{ __('adminstaticword.Pending') }}
                                                    {{ __('Request') }}</a></li>
                                        @endcan
                                        {{-- @can('instructor-plan-subscription.view')
                                            <li class="{{ Nav::isResource('plan/subscribe/settings') }}"><a
                            ...
                            @canany(['instructorrequest.view', 'instructor-pending-request.manage',
                                'instructor-plan-subscription.view'])
                                <li
                                    class="{{ Nav::isResource('plan/subscribe/settings') }} {{ Nav::isResource('subscription/plan') }}  {{ Nav::isRoute('all.instructor') }} {{ Nav::isResource('requestjob') }}">
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-user text-secondary"></i>
                                        <span>{{ __('adminstaticword.Jobs') }}<div class="sub-menu truncate">All
                                                Jobs, Pending Request</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        @can('instructorrequest.view')
                                            <li class="{{ Nav::isResource('requestjob') }}"><a
                                                    href="{{ url('requestjob') }}">{{ __('adminstaticword.All') }}
                                                    {{ __('adminstaticword.Jobs') }}</a></li>
                                        @endcan
                                        @can('instructor-pending-request.manage')
                                            <li class="{{ Nav::isRoute('jobs.pending') }}"><a
                                                    href="{{ route('jobs.pending') }}">{{ __('adminstaticword.Pending') }}
                                                    {{ __('Request') }}</a></li>
                                        @endcan
                                    </ul>
                                </li>
                            ...
                            <!-- user end -->
                            @canany(['categories.view', 'courses.view', 'course-reviews.view', 'quiz-review.view'])
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-book text-secondary"></i>
                                        <span>{{ __('adminstaticword.Course') }}<div class="sub-menu truncate">
                                                Categories,
                                                Courses, Course Review, Quiz Review</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        <!-- Category start  -->
                            ...
                            <li>
                                <a href="javaScript:void();" class="menu"><i
                                        class="feather icon-file-text text-secondary"></i>
                                    <span>{{ __('adminstaticword.e-Library') }}<div class="sub-menu truncate">
                                            e-Library list, Levels</div></span>
                                    <i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    {{-- @can('instructorrequest.view') --}}
                                    <li class="{{ Nav::isRoute('elibrary.index') }}"><a
                                            href="{{ route('elibrary.index') }}">
                                            {{ __('adminstaticword.e-Library list') }}</a></li>
                                    {{-- @endcan --}}

                                    {{-- @can('instructorrequest.view') --}}
                                    <li class="{{ Nav::isResource('level') }}"><a href="{{ url('level') }}">
                                            {{ __('adminstaticword.List Levels') }}</a></li>
                                    {{-- @endcan --}}
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('index.placementTest') }}" class="menu"><i
                                        class="feather icon-file-text text-secondary"></i>
                                    <span>
                                        {{ __('adminstaticword.Placement Test') }}
                                    </span>
                                </a>
                            </li>
                            ...
                            <!-- ====================Meetings start======================== -->
                            @canany(['meetings.zoom-meetings.view', 'meetings.big-blue.view',
                                'meetings.google-meet.view', 'meetings.jitsi-meet.view', 'meetings.google-classroom.view',
                                'meetings.meeting-recordings.view'])
                                <li
                                            ...
                                            <li
                                                ...
                                                <ul class="vertical-submenu">
                                                    <li class="{{ Nav::isRoute('jitsi.dashboard') }}"><a
                                                            href="{{ route('jitsi.dashboard') }}">{{ __('Dashboard') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        @endif
                            ...
                            @can(['institute.view'])
                                <li>
                                    <a href="{{ url('institute') }}" class="menu"><i
                                            class="feather icon-grid text-secondary"></i>
                            ...
                            @can('certificate.manage')
                                ...
                                <li class="{{ Nav::isRoute('certificate.index') }}">
                                    <a href="{{ route('certificate.index') }}" class="menu"><i
                                            class="feather icon-help-circle text-secondary"></i>
                            ...
                            @can(['coupons.view'])
                                ...
                                {{-- <li class="{{ Nav::isResource('coupon') }}">
                                    <a href="{{ url('coupon') }}" class="menu">
                                        <i
                                            class="feather icon-award text-secondary"></i><span>{{ __('adminstaticword.Coupon') }}</span>
                                    </a>
                                </li> --}}
                            @endcan
                            {{-- @can(['followers.manage'])
                                <li class="{{ Nav::isRoute('follower.view') }}">
                                    <a href="{{ route('follower.view') }}" class="menu">
                                        <i
                                            class="feather icon-help-circle text-secondary"></i><span>{{ __('Followers') }}</span>
                                    </a>
                                </li>
                            @endcan --}}
                            ...
                            <!-- coupon -->
                            @can(['orders.manage'])
                                <li class="header">{{ __('Khalilak Services') }}</li>
                            ...
                            @can(['blogs.view'])
                                ...
                                <li class="{{ Nav::isResource('blog') }}">
                                    <a href="{{ url('blog') }}" class="menu">
                                        ...
                                        <span>{{ __('Psychosocial support') }}</span>
                                    </a>
                                </li>
                            @endcan
                            <!-- pages start -->
                            ...
                            @canany(['report.progress-report.manage', 'report.quiz-report.manage',
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu">
                                        <i class="feather icon-file-text text-secondary"></i>
                                        <span>{{ __('adminstaticword.Report') }}<div class="sub-menu truncate">Quiz
                                                Report, Progress Report, Device History
                                            </div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            @endcan --}}
                            @can(['about.manage'])
                                <li class="{{ Nav::isResource('about-khalilak') }}">
                                    <a href="{{ url('about-khalilak') }}" class="menu">
                            ...
                            @canany(['faq.faq-student.view', 'faq.faq-instructor.view'])
                                <li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
                                    <a href="javaScript:void();" class="menu">
                                        ...
                                        <span>{{ __('adminstaticword.FAQ') }}<div class="sub-menu truncate">FAQ Student,
                                                FAQ Instructor</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            {{-- @can(['career.manage'])
                                <li class="{{ Nav::isRoute('careers.page') }}">
                                    <a href="{{ route('careers.page') }}" class="menu">
                                        <i
                                            class="feather icon-sidebar text-secondary"></i><span>{{ __('adminstaticword.Career') }}</span>
                                    </a>
                                </li>
                            @endcan --}}
                            <!-- faq end -->
                            ...
                            {{-- @canany(['locations.country.view', 'locations.state.view', 'locations.city.view'])
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-map-pin text-secondary"></i>
                                        <span>{{ __('Locations') }}<div class="sub-menu truncate">Country, State, City
                                            </div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            @can(['get-api-key.manage'])
                                <li class="{{ Nav::isRoute('get.api.key') }}">
                                    <a href="{{ route('get.api.key') }}" class="menu">
                                        <i
                                            class="feather icon-share text-secondary"></i><span>{{ __('adminstaticword.GetAPIKeys') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can(['currency.view'])
                                <li class="{{ Nav::isRoute('currency.index') }}">
                                    <a href="{{ route('currency.index') }}" class="menu">
                                        <i
                                            class="feather icon-dollar-sign text-secondary"></i><span>{{ __('adminstaticword.Currency') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can(['themes.manage'])
                            ...
                            @canany(['front-settings.testimonial.view', 'front-settings.advertisement.view', 'front-settings.sliders.view', 'front-settings.fact-slider.view', 'category-sliders.manage', 'get-started.manage', 'front-settings.trusted-sliders.view', 'widget.manage', 'front-settings.seo-directory.view', 'coming-soon.manage', 'terms-condition.manage', 'privacy-policy.manage', 'invoice-design.manage', 'login-signup.manage', 'video-setting.manage', 'breadcum-setting.manage', 'front-settings.fact-slider.view', 'join-an-instructor.manage '])
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-monitor text-secondary"></i>
                                        <span>{{ __('adminstaticword.FrontSetting') }}<div class="sub-menu truncate">
                                                Testimonial, Advertisement, Slider, Fact Slider, Category Slider, Get
                                                Started, Trusted Slider, Widget, Seo Directory, Coming Soon, Terms &
                                                Condition, Privacy Policy, Invoice Design, Login/Signup, Videosetting,
                                                Breadcumsetting, Factsetting, Join an Instructor</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            {{-- @canany(['settings.manage', 'pwa.manage', 'adsense-setting.manage', 'twilio-setting.manage', 'site-map-setting.manage', 'site-settings.language.view', 'email-design.manage'])
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-settings text-secondary"></i>
                                        <span>{{ __('adminstaticword.SiteSetting') }}<div class="sub-menu truncate">
                                                Setting, PWA, Adsense, IP Block Settings, Twilio, Site Map, Language, Email
                                                Design</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            {{-- @canany(['payment-setting-credentials.manage', 'payment-setting-MPESA-setting.manage', 'payment-setting-bank-details.manage', 'payment-setting.manual-payment.view'])
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-dollar-sign text-secondary"></i>
                                        <span>{{ __('Payment Setting') }}<div class="sub-menu truncate">Credentials,
                                                MPESA Settings, Bank Deatils, Manual Payment</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            {{-- @canany(['player-settings.manage', 'player-settings.advertise.view'])
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-play-circle text-secondary"></i>
                                        <span>{{ __('adminstaticword.PlayerSettings') }}<div class="sub-menu truncate">
                                                Player Customization, Advertise Settings</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                            ...
                            @can(['update-process.manage'])
                                <li class="{{ Nav::isRoute('update.process') }}">
                                    <a href="{{ route('update.process') }}" class="menu"><i
                                            class="feather icon-share text-secondary"></i><span>{{ __('adminstaticword.UpdateProcess') }}</span>
                                    </a>
                                </li>
                            @endcan --}}
                            {{-- @canany(['help-support-import-demo.manage', 'help-support-database-backup.manage', 'help-support-remove-public.manage', 'help-support-clear-cache.manage'])
                                <li class="{{ Nav::isRoute('import.view') }} {{ Nav::isRoute('database.backup') }} ">
                                    <a href="javaScript:void();" class="menu">
                                        <i class="feather icon-help-circle text-secondary"></i>
                                        <span>{{ __('adminstaticword.Help&Support') }}<div class="sub-menu truncate">
                                                Import Demo, Database Backup, Remove Public, Clear Cache</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
