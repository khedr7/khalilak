                        ...
                        @if (Auth::User()->role == 'instructor')
                            <ul class="vertical-menu">
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                            class="fa fa-podcast text-secondary"></i>
                                    ...
                                    @if (isset($zoom_enable) && $zoom_enable == 1)
                                        <ul class="vertical-submenu">
                                            ...
                                            <li
                                                ...
                                                <a href="javaScript:void();">
                                                    <i class=""></i>
                                                    <span>{{ __('adminstaticword.ZoomLiveMeetings') }}</span><i
                                                        class="feather icon-chevron-right"></i>
                                                </a>
                                                <ul class="vertical-submenu">
                                    ...
                                    @if (isset($gsetting) && $gsetting->googlemeet_enable == 1)
                                        <ul class="vertical-submenu">
                                            ...
                                            <li
                                                ...
                                                <a href="javaScript:void();">
                                                    <i class=""></i>
                                                    <span>{{ __('Google Meet Meeting') }}</span><i
                                                        class="feather icon-chevron-right"></i>
                                                </a>
                                                <ul class="vertical-submenu">
                                ...
                                {{-- <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                        ...
                                        <span>{{ __('adminstaticword.MultipleInstructor') }}<div
                                                class="sub-menu truncate">Request To Involve, Involvement Requests,
                                                Involved In Course</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                        ...
                                        <span>{{ __('adminstaticword.Question') }}
                                            / {{ __('adminstaticword.Answer') }}<div class="sub-menu truncate">
                                ...
                                <li class="{{ Nav::isResource('userenroll') }}">
                                    <a href="{{ url('userenroll') }}">
                                        <i
                                            class="feather icon-users text-secondary"></i><span>{{ __('Enrollment Requests') }}</span>
                                    </a>
                                </li>
                                <!-- userenroll end -->
                                ...
                                <!-- revenue start  -->
                                {{-- <li
                                    class="{{ Nav::isResource('pending.payout') }} {{ Nav::isRoute('admin.completed') }}">
                                    <a href="javaScript:void();" class="menu"><i
                                            class="feather icon-dollar-sign text-secondary"></i>
                                        <span>{{ __('adminstaticword.MyRevenue') }}<div class="sub-menu truncate">
                                                Pending Payout, Completed Payout</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        ...
                                        <li class="{{ Nav::isResource('pending.payout') }}">
                                            <a
                                                href="{{ route('pending.payout') }}">{{ __('adminstaticword.PendingPayout') }}</a>
                                        </li>
                                    ...
                                    <li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isResource('faq') }}">
                                                <a
                                                    href="{{ url('faq') }}">{{ __('adminstaticword.FAQStudent') }}</a>
                                            </li>
                                ...
                                <li
                                    ...
                                    <a href="javaScript:void();" class="menu"><i
                                        ...
                                        <span>{{ __('adminstaticword.Report') }}<div class="sub-menu truncate">Quiz
                                                Report, Progress Report</div></span>
                                        <i class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">

                                        <li class="{{ Nav::isResource('show/quiz/report') }}">
                                            <a href="{{ url('show/quiz/report') }}"> Quiz
