...
@section('title', 'All Placement Tests - Admin')
@section('maincontent')


    @component('components.breadcumb', ['thirdactive' => 'active'])
        @slot('heading')
            {{ __('All Placement Tests') }}
        @endslot
        @slot('menu1')
            {{ __('Placement Tests') }}
        @endslot
                ...
                <div class="widgetbar">
                    ...
                    @can('quiz-topic.create')
                        <a data-toggle="modal" data-target="#myModaltopic" href="#" class="btn btn-primary-rgba"><i
                                class="feather icon-plus "></i>{{ __('Add Placement Test') }} </a>
                    @endcan
                </div>
            </div>
        @endslot
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">{{ __('All Placement Tests') }}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th>{{ __('adminstaticword.PerQuestionMarks') }}</th> --}}
                                ...
                                <tbody>
                                    ...
                                    @foreach ($topics as $topic)
                                        <tr>
                                            <?php $i++; ?>
                                            <td>
                                                <input type="checkbox" form="bulk_delete_form10"
                                                    class="filled-in material-checkbox-input10" name="checked[]"
                                                    value="{{ $topic->id }}" id="checkbox{{ $topic->id }}">
                                                <label for="checkbox{{ $topic->id }}" class="material-checkbox"></label>
                                                <?php echo $i; ?>
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input class="slider" type="checkbox" data-id="{{ $topic->id }}"
                                                        name="status" {{ $topic->status == 1 ? 'checked' : '' }}
                                                        onchange="quiztopic('{{ $topic->id }}')" />
                                            ...
                                            {{-- <td>
                                                <label class="switch">
                                                    <input class="slider" type="checkbox" data-id="{{ $topic->id }}"
                                                        name="quiz_again" {{ $topic->quiz_again == 1 ? 'checked' : '' }}
                                                        onchange="quizreattemp('{{ $topic->id }}')" />
                                                    <span class="knob"></span>
                                                </label>
                                            </td> --}}
                                                ...
                                                <div class="modal fade bd-example-modal-sm" id="deleteq{{ $topic->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post"
                                                                    action="{{ url('admin/quiztopic/' . $topic->id) }}"
                                                                    class="pull-right">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
                ...
                <div class="panel panel-sum">
                    <div class="modal-body">
                        <form id="demo-form2" method="post" action="{{ url('admin/quiztopic/') }}"
                            ...
                            <input type="hidden" name="placement_test" value="{{ 1 }}" />


                            <div class="row">
                                <div class="col-md-12">
                                    <label for="exampleInputTit1e">{{ __('adminstaticword.Title') }}:<span
                                            class="redstar">*</span>
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="exampleInputDetails">{{ __('adminstaticword.TestDescription') }}:<sup
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="exampleInputTit1e">{{ __('adminstaticword.TestTimer') }}:<span
                                            class="redstar">*</span>
                                    </label>
                                    <input type="text" placeholder="Enter Test Time" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="exampleInputTit1e">{{ __('Test Type') }}:</label><br>
                                    <label class="switch">
