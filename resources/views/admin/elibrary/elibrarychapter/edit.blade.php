...
@section('title', 'Edit e-library Item')
@section('maincontent')
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">{{ __('adminstaticword.Edit') }} {{ __('e-Library Item') }}</h5>
                    </div>
                    <div class="card-body ml-2">
                        <form id="demo-form" method="post"
                            action="{{ url('e-library/update/' . $cate->id) }}"data-parsley-validate
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="exampleInputTit1e">{{ __('adminstaticword.Name') }} :<span
                                            class="redstar">*</span></label>
                                    <input type="" class="form-control" name="chapter_name" id="exampleInputTitle"
