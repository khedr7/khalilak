            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    <a data-toggle="modal" data-target="#myModalp" href="#" class="btn btn-primary-rgba"><i
                            class="feather icon-plus mr-2"></i>{{ __('Add Item') }}</a>
                    {{-- @endcan --}}
                </div>
            </div>
        @endslot
                        ...
                        <div class="table-responsive">
                            <table id="" class="displaytable table table-striped table-bordered w-100">
                                <thead>
                                    <tr>
                                        <th>
                                            <input id="checkboxAllcoursechapter" type="checkbox" class="filled-in"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ url('e-library-class/' . $cat->id) }}"><i
                                                                class="feather icon-edit mr-2"></i>show</a>
                                                        <a class="dropdown-item"
                                                            href="{{ url('e-library/edit/' . $cat->id) }}"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="box box-primary">
                        <div class="panel panel-sum">
                            <div class="modal-body">
                                <form id="demo-form2" method="post" action="{{ route('elibrary.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" placeholder="Enter title" class="form-control"
                                                name="chapter_name" id="exampleInputTitle" value="" required>
                                        </div>
                                        <div class="col-md-6">
