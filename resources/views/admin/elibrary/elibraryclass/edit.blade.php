...
@section('title', 'Edit e-library class')
@section('maincontent')
    ...
    @component('components.breadcumb', ['thirdactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ url('e-library-class/' . $cate->coursechapters->id) }}"
                        class="float-right btn btn-primary-rgba mr-2"><i
                            class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>

                    <a href="http://www.webdesign-flash.ro/vs/" target="_blank" class="float-right btn btn-primary-rgba mr-2"><i
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">{{ __('adminstaticword.Edit') }} {{ __('e-library Class') }}</h5>
                    </div>
                    <div class="card-body ml-2">
                        <form enctype="multipart/form-data" id="demo-form" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="type">{{ __('adminstaticword.e-Library type') }}:</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="exampleInputDetails">{{ __('adminstaticword.Levels') }}:<sup
                                            class="redstar">*</sup></label>
                                    <select name="level" id="upload_id"
                                        class="form-control select2 js-example-basic-single" required>
                                        @php
                                            $levels = App\ChapterLevel::where('chapter_id', '=', $cate->coursechapter_id)->get();
                                        @endphp
                                        ...
                                        @foreach ($levels as $level)
                                            <option value="{{ $level->id }}"
                                                {{ $cate->level_id == $level->id ? 'selected' : '' }}>
                                                {{ $level->title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            @if ($cate->type == 'video')
                                ...
                                @if ($gsetting->aws_enable == 1)
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="awsUpload"
                                                @if ($cate->video != null || $cate->iframe_url != null || $cate->url) class="display-none" @endif>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="aws_upload"
                                                            id="inputGroupFile01"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="videoURL" @if ($cate->video != null || $cate->iframe_url != null || $cate->aws_upload != null) style="display:none" @endif>
                                            ...
                                            <input type="text" id="apiUrl" value="{{ $cate->url }}"
                                                name="vidurl" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="videoUpload"
                                            @if ($cate->url != null || $cate->iframe_url != null || $cate->aws_upload != null) style="display:none" @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="iframeURLBox"
                                            @if ($cate->url != null || $cate->video != null || $cate->aws_upload != null) style="display:none" @endif>
                                            <label for="">{{ __('adminstaticword.IframeURL') }}: </label>
                                            <input type="text" value="{{ $cate->iframe_url }}" name="iframe_url"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="liveURLBox"
                                            @if ($cate->iframe_url != null || $cate->video != null || $cate->aws_upload != null || $cate->url != null) style="display:none" @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="duration">
                                        ...
                                        <input type="text" name="duration" value="{{ $cate->duration }}"
                            ...
                            @if ($cate->type == 'audio')
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div id="audioURL" @if ($cate->audio != '') style="display:none" @endif>
                                            <label for="">{{ __('adminstaticword.URL') }}: </label>
                                            <input type="text" value="{{ $cate->url }}" name="audiourl"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div id="audioUpload"
                                            @if ($cate->url != '') style="display:none" @endif>
                            ...
                            @if ($cate->type == 'image')
                                ...
                                <div class="form-group">
                                    <div class="col-md-12" id="size">
                                        ...
                                        <input type="text" name="size" value="{{ $cate->size }}"
                                            class="form-control">
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($cate->type == 'pdf')
                                <div class="col-md-12" id="pdftype">
                                    <input type="radio" name="checkPdf" id="ch8" value="url"
                                        {{ $cate->url != '' ? 'checked' : '' }}> {{ __('adminstaticword.URL') }}
                                    <input type="radio" name="checkPdf" id="ch9"
                                        {{ $cate->pdf != '' ? 'checked' : '' }} value="uploadpdf">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12" id="pdfURL"
                                        @if ($cate->pdf != '') class="display-none" @endif>
                                        <div id="pdfURL"
                                            @if ($cate->pdf != '') class="display-none" @endif>
                                            <label for=""> {{ __('adminstaticword.URL') }}: </label>
                                            <input type="text" value="{{ $cate->url }}" name="pdfurl"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- @if ($cate->type == 'video')
                                <div class="row">
                                    <div class="col-md-12">
                                        <label
                                            for="exampleInputDetails">{{ __('adminstaticword.PreviewVideo') }}:</label><br>
                                        <!-- ============== -->
                                        <label class="switch">
                                        ...
                                        <div @if ($cate->preview_type == 'url') class="display-none" @endif
                                            id="document11">
                                            <label for="exampleInputSlug">{{ __('Preview') }}
                                                {{ __('adminstaticword.UploadVideo') }}: <sup
                                                    class="redstar">*</sup></label>
                                            <!-- =========== -->
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                        ...
                                        <div @if ($cate->preview_type == 'video') class="display-none" @endif
                                            id="document22">

                                            <label for="exampleInputSlug">{{ __('Preview') }}
                                                {{ __('adminstaticword.URL') }}: <sup class="redstar">*</sup></label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file"
                                                ...
                                                value="{{ $cate->file }}" name="file" id="inputGroupFile01"
                                                aria-describedby="inputGroupFileAddon01">
                                            <label class="custom-file-label"
                                                for="inputGroupFile01">{{ __('Choose file') }}</label>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="switch">
                                        <input class="slider" type="checkbox" data-id="{{ $cate->id }}"
                                            name="featured" {{ $cate->featured == '1' ? 'checked' : '' }} />
                                        <span class="knob"></span>
                                    </label>
                                    <!-- ============== -->
                            ...
                            @if ($cate->courses->drip_enable == 1)
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control js-example-basic-single" id="drip_type"
                                            name="drip_type">
                                            <option value="" selected hidden>
                                                {{ __('Select an Option ') }}
                                            </option>
                                            <option value="date" {{ $cate->drip_type == 'date' ? 'selected' : '' }}>
                                                {{ __('Specific Date') }}</option>
                                            <option value="days" {{ $cate->drip_type == 'days' ? 'selected' : '' }}>
                                                {{ __('Days After Enrollment') }}</option>
                                        </select>
                                        <br>
                                    </div>

                                    <div class="col-md-6" @if ($cate->drip_type == 'days' || $cate->drip_type == null) style="display: none;" @endif
                                        id="dripdate">
                                    ...
                                    <div class="col-md-6" @if ($cate->drip_type == 'date' || $cate->drip_type == null) style="display: none;" @endif
                                        id="dripdays">
                                        <label>{{ __('Days After Enrollment') }} :</label>
                                        <input type="number" min="1" class="form-control" name="drip_days"
                                            value="{{ optional($cate)->drip_days }}">
                                        <small class="text-muted"><i class="fa fa-question-circle"></i>
                                            {{ __('Enter days') }}.</small>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        $(function() {
            var urlLike = '{{ url('level/dropdown') }}';
