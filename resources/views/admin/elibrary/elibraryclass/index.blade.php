...
@section('title', 'e-library Classes - Admin')
@section('maincontent')


    @component('components.breadcumb', ['thirdactive' => 'active'])
        @slot('heading')
            {{ $e_chapter->chapter_name }} {{ __('classes') }}
        @endslot
        @slot('menu1')
            {{ __('e-library') }}
        @endslot
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    <a data-toggle="modal" data-target="#myModalab" href="#" class="btn btn-primary-rgba"><i
                            class="feather icon-plus "></i>{{ __('Add Class') }}</a>
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">{{ __('Classes') }}</h5>
                        {{-- @can('course-class.delete') --}}
                        {{-- <button type="button" class="btn btn-danger-rgba mr-2 " data-toggle="modal"
                                data-target="#bulk_delete4"><i class="feather icon-trash mr-2"></i> Delete Selected</button> --}}
                        {{-- @endcan --}}
                            ...
                            <table id="example1" class="displaytable table table-striped table-bordered w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('adminstaticword.Level') }}</th>
                                ...
                                <tbody id="sortable">
                                    ...
                                    @foreach ($classes as $cat)
                                        <tr class="sortable row1" data-id="{{ $cat->id }}">
                                            ...
                                            @php
                                                $chname = App\ChapterLevel::where('id', '=', $cat->level_id)->get();
                                            @endphp
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ url('e-library-class/edit/' . $cat->id) }}"><i
                                    ...
                                    <div class="modal-body">
                                        <form enctype="multipart/form-data" id="demo-form2" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                        for="exampleInputDetails">{{ __('adminstaticword.e-Library type') }}:<sup
                                                            class="redstar">*</sup></label>
                                                    <select name="course_chapters" id="chapter_id"
                                                        class="form-control select2 js-example-basic-single" required>
                                                        @foreach ($coursechapters as $c)
                                                            <option {{ $cat->chapter_id == $c->id ? 'selected' : '' }}
                                                                value="{{ $c->id }}">{{ $c->chapter_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                        for="exampleInputDetails">{{ __('adminstaticword.Levels') }}:<sup
                                                            class="redstar">*</sup></label>
                                                    <select name="level" id="upload_id"
                                                        class="form-control select2 js-example-basic-single" required>
                                                        @php
                                                            $levels = App\ChapterLevel::where('chapter_id', '=', $cat->chapter_id)->get();
                                                        @endphp
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label
                                                        for="exampleInputDetails">{{ __('adminstaticword.Title') }}:<sup
                                                            class="redstar">*</sup></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" id="imageUpload" style="display:none">
                                                    <label for="">{{ __('adminstaticword.UploadImage') }}:
                                                    </label>
                                                    <!-- =========== -->
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                ...
                                                @if ($gsetting->aws_enable == 1)
                                                    <div class="col-md-12" id="awsBox" style="display:none">
                                                        <label
                                                            for="appt">{{ __('adminstaticword.AWSUpload') }}</label>
                                                        <!-- =========== -->
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"
                                                ...
                                                <div class="col-md-12" id="zipUpload" style="display:none">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                name="uplzip" id="inputGroupFile01"
                                                                aria-describedby="inputGroupFileAddon01">
                                                            <label class="custom-file-label" for="inputGroupFile01">Choose
                                                                file</label>
                                                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @if (is_null(env('YOUTUBE_API_KEY')))
                                <p>Make Sure You Have Added Youtube API Key in <a
                                        href="{{ url('admin/api-settings') }}">API Settings</a></p>
                            @endif
