                        ...
                        <form action="{{ route('admin.push.notif') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select required data-placeholder="Please select user group" name="user_group"
                                    ...
                                    <option {{ old('user_group') == 'all_volunteers' ? 'selected' : '' }}
                                        value="all_sellers">
                                        {{ __('adminstaticword.All') }} {{ __('adminstaticword.Volunteers') }} </option>
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-info">
                                    ...
                                    {{ __('On click of notification where you want to
                                                                    redirect the user') }}.
                                </small>
                            </div>
                            <div class="form-group">
                                ...
                                <small class="text-info">
                                    <i
                                        class="fa fa-question-circle"></i>{{ __('If not enter than default icon will use which you
                                                                        upload at time
                            ...
                            <div style="display: {{ old('show_button') ? 'block' : 'none' }};" id="buttonBox">
                                <div class="form-group">
                                    <label for="">{{ __('adminstaticword.ButtonText') }}: <span
                                            class="text-danger">*</span></label>
                                    <input value="{{ old('btn_text') }}" class="form-control" name="btn_text"
                                        type="text" placeholder="Grab Now !">
                                </div>
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">
                                        <i class="fa fa-question-circle"></i>
                                        {{ __('On click of button where you want to redirect
                                                                            the user') }}.
                                    </small>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('onesignal.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input id="password-field" value="{{ env('ONESIGNAL_APP_ID') }}" type="password"
                                        name="ONESIGNAL_APP_ID" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input id="password-fieldscds" value="{{ env('ONESIGNAL_REST_API_KEY') }}"
                                        type="password" name="ONESIGNAL_REST_API_KEY" class="form-control"
