                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $user->fname }}" autofocus required name="fname" type="text"
                                            class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autofocus name="linkedin_url" value="{{ $user->linkedin_url }}"
                                            type="text" class="form-control" placeholder="https://linkedin.com" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $user->pin_code }}"
                                            placeholder="{{ __('adminstaticword.Please') }} {{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Pincode') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autofocus name="youtube_url" value="{{ $user->youtube_url }}"
                                            type="text" class="form-control" placeholder="https://youtube.com" />
