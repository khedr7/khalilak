<div class="dropdown">
    <button class="btn btn-round btn-outline-primary" type="button" id="CustomdropdownMenuButton1" data-toggle="dropdown"
        aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-vertical-"></i>
    </button>
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        @can('Alluser.edit')
            <a class="dropdown-item" href="{{ route('user.edit', $id) }}"><i class="feather icon-edit mr-2"></i>Edit</a>
        @endcan
        @can('Alluser.delete')
