...
@section('title', 'Edit Psychosocial activity - Admin')
@section('maincontent')
    @component('components.breadcumb', ['fourthactive' => 'active'])
        @slot('heading')
            {{ __('Update Psychosocial activity') }}
        @endslot
        @slot('menu1')
            {{ __('Update Psychosocial activity') }}
        @endslot
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <h5 class="card-box"> {{ __('adminstaticword.Update Psychosocial activity') }}</h5>
                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $show->heading }}"
                                                                    autofocus=""
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label
                                                                    class="text-dark">{{ __('adminstaticword.ButtonText') }}
                                                                    : <span class="text-danger">*</span></label>
                                                                <input type="text" value="{{ $show->text }}"
                                                                    autofocus=""
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="detail" name="detail" class="@error('detail') is-invalid @enderror"
                                                                    placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}" required="">{{ $show->detail }}</textarea>
                                                                @error('detail')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        @if (Auth::user()->role == 'admin')
                                                            <div class="form-group">
                                                                ...
                                                                <small class="text-info"> <i
                                                                        class="text-dark feather icon-help-circle"></i>({{ __('Choose Image for Psychosocial activity post') }})</small>
                                                                <br>
                                                                <img src=" {{ url('images/blog/' . $show->image) }}"
                                                                    class="pro-img" />
                                                            </div>
