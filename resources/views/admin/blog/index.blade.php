...
@section('title', 'Psychosocial support - Admin')
@section('maincontent')
    @component('components.breadcumb', ['fourthactive' => 'active'])
        @slot('heading')
            {{ __('Psychosocial support') }}
        @endslot
        @slot('menu1')
            {{ __('Psychosocial support') }}
        @endslot
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    @endcan
                    @can('blogs.create')
                        <a href="{{ url('blog/create') }}" class="float-right btn btn-primary-rgba mr-2"><i
                                class="feather icon-plus mr-2"></i>{{ __('Add activity') }}</a>
                    @endcan
                </div>
            </div>
        @endslot
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <h5 class="card-box">{{ __('adminstaticword.Psychosocial support') }}</h5>
                    </div>
                                    ...
                                    @foreach ($items as $item)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->role == 'admin')
                                                {{-- <td>
                                                    <label class="switch">
                                                        <input class="blogapproved" type="checkbox"
                                                            data-id="{{ $item->id }}" name="approved"
                                                            {{ $item->approved == '1' ? 'checked' : '' }}>
                                                        <span class="knob"></span>
                                                    </label>
                                                </td> --}}
                                                <td>
                                                    <label class="switch">
                                                        <input class="blogstatus" type="checkbox"
