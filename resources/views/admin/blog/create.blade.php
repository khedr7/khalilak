...
@section('title', 'Add Psychosocial activity - Admin')
@section('maincontent')
    @component('components.breadcumb', ['fourthactive' => 'active'])
        @slot('heading')
            {{ __('Add Psychosocial activity') }}
        @endslot
        @slot('menu1')
            {{ __('Psychosocial activity') }}
        @endslot
        @slot('button')
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <h5 class="card-box"> {{ __('adminstaticword.Add Psychosocial activity') }}</h5>
                    </div>
