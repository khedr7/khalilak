...
@section('title', 'Create a new volunteer')
@section('breadcum')
    @component('components.breadcumb', ['secondaryactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ route('allvolunteer.index') }}" class="float-right btn btn-primary-rgba mr-2"><i
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-tittle">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.Volunteer') }}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="form-group">
                                        <label class="text-dark"
                                            for="city_id">{{ __('adminstaticword.Country') }}:</label>
                    ...
                    ">{{ __('Please Select an Option') }}
                                    ...
                                    <div id="other_type" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('other_type') }}" name="other_type" type="text"
                                                class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="role" required>
                                            ...
                                            <option value="Volunteer">{{ __('adminstaticword.Volunteer') }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label class="text-dark"
