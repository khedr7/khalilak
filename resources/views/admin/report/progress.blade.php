                                ...
                                <tbody>
                                    @foreach ($user as $key => $pro)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($pro['user_img'] != null &&
                                                    $pro['user_img'] != '' &&
                                                    @file_get_contents('../public/images/user_img/' . $pro->user_img))
                                                    <img src="{{ url('images/user_img/' . $pro->user_img) }}"
                                                        alt="profilephoto" class="img-responsive img-circle">
                                                @else
                                                    <img src="{{ Avatar::create($pro->user_name)->toBase64() }}"
                                                        alt="profilephoto" class="img-responsive img-circle">
                                                @endif
                                                &emsp;
                                                {{ $pro->user_name }}
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group mr-2">
                                                    <a href="{{ url('progress/report/' . $pro->id) }}"
                                                        class="btn btn-xs btn-primary-rgba"><i
