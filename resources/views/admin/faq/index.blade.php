            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    @can('faq.faq-student.create')
                        <a href="{{ url('faq/create') }}" class="float-right btn btn-primary-rgba mr-2"><i
                                ...
                                <tbody>
                                    @foreach ($faq as $key => $p)
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input class="faq" type="checkbox" data-id="{{ $p->id }}"
                                                        name="status" {{ $p->status == '1' ? 'checked' : '' }}>
