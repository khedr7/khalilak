    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="box-title">{{ __('All Pending Request') }}</h5>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($pendings as $order)
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        ...
                                        <p><b>{{ __('adminstaticword.TotalAmount') }}</b>:
                                            ...
                                            @else
                                                @if ($contains)
                                                    <i
                                                        class="fa {{ $order->currency_icon }}"></i>{{ $order->total_amount }}
                                                    @if ($order->subscription_id !== null)
                                                        / {{ $order->bundle->billing_interval }}
                                                    @endif
                                                @else
                                    ...
                                    <td>
                                        ...
                                        <label class="switch">
                                            <input class="orders" type="checkbox" data-id="{{ $order->id }}"
                                                name="status" {{ $order->status == '1' ? 'checked' : '' }}>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                <a class="dropdown-item"
                                                    href="{{ route('view.order', $order->id) }}"><i
