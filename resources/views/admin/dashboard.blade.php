                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <h4>{{ $blogs }}</h4>
                                            <p class="font-14 mb-0">{{ __('psychosocial supports') }}</p>
                                        </div>
                                        <div class="col-6 text-right">
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <h4>{{ $orders }}</h4>
                                            <p class="font-14 mb-0">{{ __('Enrollment') }}</p>
                                        </div>
                                        <div class="col-6 text-right">
                                            ...
                                            <div class="user-slider-item">
                                                <div class="card-body text-center">
                                                    <span class="action-icon badge badge-primary-inverse">
                                                        @if ($topusers['user_img'] != null &&
                                                            $topusers['user_img'] != '' &&
                                                            @file_get_contents('images/user_img/' . $topusers['user_img']))
                                                            <img src="{{ url('images/user_img/' . $topusers['user_img']) }}"
                                                                class="dashboard-imgs" alt="">
                                                        @else
                                                            <img src="{{ Avatar::create($topusers->fname)->toBase64() }}"
                                                                class="dashboard-imgs" alt="">
                                                        @endif
                                                    ...
                                                    <p>{{ $topusers->email }}</p>
                                                    {{-- <p><span
                                                            class="badge badge-primary-inverse">{{ __('Verified') }}:{{ $topusers['verified'] }}</span>
                                                    </p> --}}
                                    ...
                                    @foreach ($topinstructor as $topinstructors)
                                        <div class="user-slider">
                                            <div class="user-slider-item">
                                                <div class="card-body text-center">
                                                    <span class="action-icon badge badge-primary-inverse">
                                                        @if ($topinstructors['user_img'] != null &&
                                                            $topinstructors['user_img'] != '' &&
                                                            @file_get_contents('images/user_img/' . $topinstructors['user_img']))
                                                            <img src="{{ url('images/user_img/' . $topinstructors['user_img']) }}"
                                                                class="dashboard-imgs" alt="">
                                                        @else
                                                            <img src="{{ Avatar::create($topinstructors->fname)->toBase64() }}"
                                                                class="dashboard-imgs" alt="">
                                                        @endif
                                                    </span>
                                                ...
                                                <div class="card-footer text-center">
                                                    <div class="row">
                                                        <div class="col-12 border-right">
                                                            <h4>{{ date('jS F Y', strtotime($topinstructors->created_at)) }}
                                                            </h4>
                                                            <p class="my-2">{{ __('Created At') }}</p>
                                                        </div>
                                                ...
                                                <div class="card-body text-center">
                                                    <span class="action-icon badge badge-primary-inverse">
                                                        @if ($topcourses['preview_image'] !== null && $topcourses['preview_image'] !== '')
                                                            <img src="{{ asset('images/course/' . $topcourses['preview_image']) }}"
                                                                class="dashboard-imgs" alt="">
                                                        @else
                                                            <img src="{{ Avatar::create($topcourses->title)->toBase64() }}"
                                                                class="dashboard-imgs" alt="">
                                                        @endif
                                                    ...
                                                    {{-- <p>
                                                        @if ($topcourses->discount_price == null)
                                                            <span class="badge badge-primary-inverse">{{ __('Price') }}:
                                                                free</span>
                                                        @else
                                                            <span class="badge badge-primary-inverse">{{ __('Price') }}:
                                                                free</span>
                                        ...
                                        @if (!is_null($toporders->user))
                                            <div class="user-slider">
                                                <div class="user-slider-item">
                                                    <div class="card-body text-center">
                                                        <span class="action-icon badge badge-primary-inverse">
                                                            @if ($toporders->user->user_image != null &&
                                                                $toporders->user->user_image != '' &&
                                                                @file_get_contents('images/user_img/' . $toporders->user->user_image))
                                                                <img src="{{ url('images/user_img/' . $toporders->user->user_image) }}"
                                                                    class="dashboard-imgs" alt="">
                                                            @else
                                                                <img src="{{ Avatar::create($toporders->user->fname)->toBase64() }}"
                                                                    class="dashboard-imgs" alt="">
                                                            @endif

                                                        </span>
                                                        <h5>{{ $toporders->user->fname }}</h5>
                                                        <p>{{ $toporders->courses->title }}</p>
                                                        {{-- <p>{{ $toporders->payment_method }}</p> --}}
                                                        {{-- <p><span
                                                                class="badge badge-primary-inverse">{{ __('Price') }}:{{ $toporders->total_amount }}</span>
                                                        </p> --}}
                                                    ...
                                                    <div class="card-footer text-center">
                                                        <div class="row">
                                                            <div class="col-12 border-right">
                                                                <h4>{{ date('jS F Y', strtotime($toporders->created_at)) }}
                                                                </h4>
                                                                <p class="my-2">{{ __('Created At') }}</p>
                                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card m-b-30 mt-md-2">
                                <div class="card-header">
                                    <h5 class="card-title">{{ __('Monthly Registred Users in') }}
                                        {{ (new DateTime())->format('Y') }}</h5>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6 mt-md-3 chart_height">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">{{ __('Total Enrollment in') }} {{ (new DateTime())->format('Y') }}
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div id="apex-chart">
                                                            ...
                                                            {{-- <td><span class="badge badge-warning">
                                                                    @if ($course->type == 1)
                                                                        ...
                                                                        @else
                                                                            @if ($gsetting['currency_swipe'] == 1)
                                                                                <i
                                                                                    class="{{ $currency['icon'] }}"></i>{{ $course['price'] }}
                                                                            @else
                                                                                {{ $course['price'] }}<i
                                                                                    class="{{ $currency['icon'] }}"></i>
                                                                            @endif
