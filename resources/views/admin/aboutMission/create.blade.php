...
@section('title', 'Add Mission and Vission')
@section('maincontent')
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <h5 class="card-box"> {{ __('adminstaticword.Add') }} Mission and Vission</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- form start -->
                        <form action="{{ url('about-khalilak/') }}" class="form" method="POST" novalidate
