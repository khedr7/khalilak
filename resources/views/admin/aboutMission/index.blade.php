            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    @can('institute.create')
                        <a href="{{ url('about-khalilak/create') }}" class="btn btn-primary-rgba"><i
                                class="feather icon-plus mr-2"></i>{{ __('add Mission and vision') }}</a>
                        <a href="{{ route('videosetting') }}" class="btn btn-success-rgba"><i
                                class="feather icon-plus mr-2"></i>{{ __('Add About Video') }}</a>
                    @endcan
                    {{-- {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            @if (Auth::User()->role == 'admin')
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($about as $key => $mission)
                                            <tr>
                                                <td>{{ filter_var($key + 1) }}</td>
                                                {{-- <td><img src="{{ asset('files/institute/' . $mission->image) }}"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('about-khalilak.edit', $mission->id) }}"><i
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post"
                                                                    action="{{ route('about-khalilak.destroy', $mission->id) }}"
