            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <!-- form start -->
                        <form action="{{ url('page/') }}" class="form" method="POST" novalidate
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label
                                                                    class="text-dark">{{ __('adminstaticword.Slug') }}:</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="detail" name="details" class="@error('details') is-invalid @enderror"
                                                                    placeholder="Please Enter Description" required="">{{ old('details') }}</textarea>
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
