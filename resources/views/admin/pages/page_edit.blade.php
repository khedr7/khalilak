    ...
    @component('components.breadcumb', ['fourthactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ url('page') }}" class="btn btn-primary-rgba"><i
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <!-- form start -->
                        <form action="{{ url('page/' . $find->id) }}" class="form" method="POST" novalidate
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="detail" name="details" class="@error('details') is-invalid @enderror"
                                                                    placeholder="Please Enter Description" required="">{{ old('details') }}
