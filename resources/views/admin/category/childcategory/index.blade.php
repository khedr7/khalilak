                                ...
                                <tbody>
                                    ...
                                    @foreach ($childcategory as $cat)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $category1 = App\Categories::where('id', '=', $cat->category_id)->get();
                                                @endphp
                                                {{-- @if (isset($cat->category)) --}}
                                                @foreach ($category1 as $cc)
                                                    {{ $cc->title }}
                                                @endforeach
                                                {{-- @endif --}}
                                            </td>
                                        ...
                                        <form method="post" action="{{ route('childcategory.store') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <select name="category_id" id="category_id1"
                                                        class="form-control select2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <select name="subcategories" mt-6name="subcategories" id="upload_id1"
                                                        class="form-control select2">
                                                        <option value="0">{{ __('adminstaticword.PleaseSelect') }}
