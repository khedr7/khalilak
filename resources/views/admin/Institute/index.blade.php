                                ...
                                <tbody>
                                    @foreach ($institute as $key => $item)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('files/institute/' . $item->image) }}"
                                            ...
                                            {{-- <td>
                                                    <label class="switch">
                                                        <input class="verify" type="checkbox" name="verify"
                                                            data-id="{{ $item->id }}"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                                        <a class="dropdown-item"
                                                            href="{{ route('institute.edit', ['id' => $item->id]) }}"><i
                                                                class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target=".bd-example-modal-sm{{ $item->id }}"><i
                                            ...
                                            {{-- <td> --}}
                                                <div class="modal fade bd-example-modal-sm{{ $item->id }}" tabindex="-1" role="dialog"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post"
                                                                    action="{{ route('institute.delete', ['id' => $item->id]) }}
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            @can('institute.edit')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('institute.edit', ['id' => $value->id]) }}"><i
                                                                        class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                                                            @endcan
                                                ...
                                                <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post"
                                                                    action="{{ route('institute.delete', ['id' => $value->id]) }}
                                              "data-parsley-validate
                                                                    class="form-horizontal form-label-left">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
