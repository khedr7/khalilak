                    ...
                    <div class="card-body">
                        <form id="demo-form2" method="post" action="{{ route('institute.save') }}" data-parsley-validate
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputSlug"> {{ __('Logo') }}:<sup
                                ...
                                <div class="form-group col-md-6">
                                    <label class="text-dark" for="longitude">{{ __('adminstaticword.Longitude') }}: <sup
                                            class="text-danger">*</sup></label>
                                    <input value="{{ old('longitude') }}" required type="number" name="longitude"
                                ...
                                <div class="form-group col-md-6">
                                    <label class="text-dark" for="latitude">{{ __('adminstaticword.Latitude') }}: <sup
                                            class="text-danger">*</sup></label>
                                    <input value="{{ old('latitude') }}" required type="number" name="latitude"
                                ...
                                {{-- <div class="col-md-6 form-group">
                                    <label for="exampleInputSlug">{{ __('Skills') }}:<sup
                                            class="redstar text-danger">*</sup></label>
                                    <input type="text" name="skill" id="tagsinput-default" class="form-control"
                                        data-role="tagsinput" />
                                </div> --}}
                                ...
                                {{-- <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="affilated_by" class="form-control" data-role="tagsinput" />
                                </div> --}}
                                <div class="form-group col-md-6">
