<meta name="google-signin-client_id" content="337675111281-quboimaiek6pe1kndflankup13j5lbfg.apps.googleusercontent.com
">
    ...
    @component('components.breadcumb', ['fourthactive' => 'active'])
        ...
        @slot('button')
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ url('googlemeet/dashboard') }}" class="btn btn-primary-rgba"><i
                        ...
                        <form autocomplete="off" action="{{ route('googlemeet.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" type="file" name="image" id="image"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="topic" placeholder="{{ __('Example: My Meeting') }}"
                                ...
                                <div class="form-group col-md-6" id="sec5_four">
                                    ...
                                    <div class="input-group" id='datetimepicker1'>
                                        <input type="text" name="end_time" id="time-format1" class="form-control"
                                            placeholder="dd/mm/yyyy - hh:ii aa" aria-describedby="basic-addon5" />
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon5"><i
                                                    class="feather icon-calendar"></i></span>
                                ...
                                <div class="form-group col-md-6" id="sec3_three">
                                    ...
                                    <input type="text" name="agenda" placeholder="Meeting Agenda"
                                        class="form-control" required>
                                ...
                                <div class="form-group col-md-12" id="sec3_three">
                                    ...
                                    <small class="text-muted"><i class="fa fa-question-circle"></i>
                                        {{ __('Set to None if you want to use your account timezone') }}.</small>
